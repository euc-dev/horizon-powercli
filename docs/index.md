...
1. Download the [Omnissa.VimAutomation.HorizonView](https://github.com/euc-dev/horizon-powercli/releases/download/2512/horizon4powercli_2512.zip) module and follow the [installation steps](./download/index.md#installation-steps)
